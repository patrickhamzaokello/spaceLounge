...
*/
    ...
    private void notifyUser(String title, String messageBody,String type,String imagePath) {
        ...
        NotificationCompat.Builder notificationBuilder =
                new NotificationCompat.Builder(this, channelId)
                        .setSmallIcon(R.drawable.ic_mycart)
    ...
    public void notificationActions(Map<String,String> dataMap)
    {
        ...
        Intent intent1 = new Intent(CustomMessagingService.this, RootActivity.class);
        ...
        builder3.setSmallIcon(R.drawable.ic_mycart)
                .setContentTitle(title)
                .setContentText(message)
                .setColor(Color.BLUE)
                .setSound(defaultSoundUri)
    ...
    public void directReply(Map<String,String> dataMap)
    {
        ...
        builder4 .setSmallIcon(R.drawable.ic_mycart)
                .setContentTitle(title)
                .setContentText(message)
                .setAutoCancel(true)
                .setSound(defaultSoundUri)
    ...
    public void messageTypeNotification(Map<String,String> dataMap)
    {
        ...
        builder6.setSmallIcon(R.drawable.ic_mycart)
                .setColor(Color.RED)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.ic_mycart))
                .setSound(defaultSoundUri)
                .setStyle(style)
                .setAutoCancel(true);
        builder6.build();
